...
public class MVdWPapiHook {
	...
	public void registerPlaceholders() {
	    ...
	    PlaceholderAPI.registerPlaceholder(main, "hexiaranks_rebirth_name", new PlaceholderReplacer() {
			@Override
			public String onPlaceholderReplace(PlaceholderReplaceEvent e) {
				if(!e.isOnline()) {
					return "Offline";
	    ...
	    PlaceholderAPI.registerPlaceholder(main, "hexiaranks_rebirth_displayname", new PlaceholderReplacer() {
			@Override
			public String onPlaceholderReplace(PlaceholderReplaceEvent e) {
				if(!e.isOnline()) {
					return "Offline";
